...
if User.count == 0
  c = Customer.new({:name=>'Chronstack', :zipcode=>'20170'})
  u = User.new({:first_name=> 'Technical', :last_name=>'Support', :email=>'technicalsupport@resourcestack.com', :user=>true, :cm=>true, :admin=>true, :password=> 'pass@123'})
  u.customer = c
